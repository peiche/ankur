...
<p class="has-contrast-medium-color has-text-color has-sm-font-size">This is a label</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h2 class="has-text-align-center">Lorem ipsum dolor sit amet consectetur adipisicing elit</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam vero aliquam, natus quae architecto hic quod!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button is-style-underline is-style-fill"><a class="wp-block-button__link wp-element-button">Learn more</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->